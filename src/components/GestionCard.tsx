import { Calendar, User, Tag, CheckSquare, Hash, Check } from "lucide-react";
...
export function GestionCard({
  ...
  tasksDone, tasksTotal, isDone = false, onClick, onMarkDone,
}: GestionCardProps) {
          ...
          <div className="flex items-start gap-2">
            ...
            {onMarkDone && (
              <button
                ...
                title={isDone ? "Completado" : "Marcar como completo"}
            ...
            <div className="flex-1 min-w-0">
              ...
              <h4 className={`text-sm font-medium leading-snug mb-1 ${isDone ? "line-through text-muted-foreground" : "text-card-foreground"}`}>
                {title}
              </h4>
